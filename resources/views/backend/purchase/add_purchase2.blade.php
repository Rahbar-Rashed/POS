...
<script id="document-template" type="text/x-handlebars-template">
	<tr id="dynamic_input_field" class="dynamic_input_field">
		...
		<td><input class="form-control form-control-sm text-right buying_qty" name="buying_qty[]" type="number" value="1"/></td>
		<td><input min="1" name= unit_price[] class="form-control form-control-sm text-right unit_price" type="number"/></td>
		<td><input name= description[] class="form-control form-control-sm" type="text"/></td>
		<td><input id="buying_price" name="buying_price[]" class="form-control form-control-sm text-right buying_price" value="0" type="number" readonly/></td>
		<td> <i class="fa fa-window-close btn btn-danger removeeventmore"></i> </td>
	</tr>
</script>
...
<script type="text/javascript">
	...
	$(document).on('click', '.removeeventmore', function(event){
		$(this).closest('#dynamic_input_field').remove();
		total_amount();
	});

	$(document).on('keyup click', '.buying_qty, .unit_price', function(){
		var product_quantity = $(this).closest("tr").find('input.buying_qty').val();
		var product_price = $(this).closest("tr").find('input.unit_price').val();
