...
<head>
   ...
   <!--  <link rel="stylesheet" href="{{asset('public/BackEnd/assets/css/toaster.css')}}"> -->
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>
    <script src="{{asset('public/BackEnd/assets/js/jquery.min.js')}}" type="text/javascript"></script>
...
<script src="{{asset('public/BackEnd/assets/js/notify.min.js')}}" type="text/javascript"></script>
<script src="{{asset('public/BackEnd/assets/js/sweet_alert.min.js')}}"></script>
